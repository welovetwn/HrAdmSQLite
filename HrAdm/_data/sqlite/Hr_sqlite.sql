...
, [Name_zhTW] nvarchar(30) NOT NULL COLLATE NOCASE
, [Name_zhCN] nvarchar(30) NULL COLLATE NOCASE
...
where status=1
order by Id',1);
INSERT INTO [XpCode] ([Type],[Value],[Name_zhTW],[Name_zhCN],[Name_enUS],[Sort],[Ext],[Note]) VALUES (
