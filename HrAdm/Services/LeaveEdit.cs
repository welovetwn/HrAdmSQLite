    ...
    public class LeaveEdit : XgEdit
    {
        ...
        override public EditDto GetDto()
        {
            ...
            return new EditDto
            {
                ...
                ReadSql = $@"
select l.*,
    c.Name_{locale} as FlowStatusName,
    u.Name as CreatorName,
    u2.Name as ReviserName,
    u3.Id as {_Fun.FidUser}, u3.DeptId as {_Fun.FidDept} 
from Leave l
join XpCode c on c.Type='FlowStatus' and l.FlowStatus=c.Value
join User u on l.Creator=u.Id
left join User u2 on l.Reviser=u2.Id
join User u3 on l.UserId=u3.Id
where l.Id='{{0}}'
",
                Items = new EitemDto[] 
				{
