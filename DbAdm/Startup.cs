...
namespace DbAdm
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //5.ado.net for sqlite
            services.AddTransient<DbConnection, SqliteConnection>();
            services.AddTransient<DbCommand, SqliteCommand>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            _Fun.Init(env.IsDevelopment(), app.ApplicationServices, DbTypeEnum.SQLite);
